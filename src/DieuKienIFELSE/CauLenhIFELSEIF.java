...
public class CauLenhIFELSEIF {
    ...
    public void checkRoleAndMenuDisplay(String role) {
        if (role.equals("Admin")) {
            ...
            //Dùng auto để check đủ 15 cái menu
        } else if (role.equals("Customer")) {
            System.out.println("Thấy 5 menu");
            //Dùng auto để check đủ 5 cái menu
        } else if (role.equals("Employee")) {
            System.out.println("Chuyển đến trang User Home");
            //Dùng auto để check đủ 10 cái menu
        } else {
            System.out.println("Chuyển đến trang Project Manager");
        }
